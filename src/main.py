...
def main():
    ...
    # Initialize sensors
    sensors = Sensors(
        sensor_log_interval=CONFIG.sensor_log_interval
    )
    ...
    videoprocessor = VideoProcessor(
        video_fps=CONFIG.video_fps,
        EcoMotionZip_path = CONFIG.EcoMotionZip_path,
        python_interpreter_path = CONFIG.python_interpreter_path,
