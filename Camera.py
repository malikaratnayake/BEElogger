...
class VideoRecorder:
    ...
    def record_video(self, test = False):
        ...
        os.system("libcamera-vid -v 0 -n --vflip --autofocus-mode continuous --autofocus-range full --autofocus-speed fast -t {} --framerate {} --width {} --height {} --codec {} -o {}".format(duration, 
                                                                                                           self.video_fps, 
